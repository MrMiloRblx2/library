...
function Kavo.CreateLib(kavName, themeList)
    ...
    local UIAspectRatioConstraint_Toggle = Instance.new("UIAspectRatioConstraint")
    ...
    ToggleButton.BackgroundColor3 = Color3.fromRGB(62, 62, 62);
    ToggleButton.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
    ToggleButton.BackgroundTransparency = 0.3
    ToggleButton.Size = UDim2.new(0.15185, 0, 0.05319, 0)
    ToggleButton.BorderColor3 = Color3.fromRGB(28, 42, 54)
    ToggleButton.Text = "Open Kavo"
    ToggleButton.Name = "ToggleButton"
    ToggleButton.Position = UDim2.new(0.43148, 0, 0.04255, 0)
    ...
    UICorner_Toggle.CornerRadius = UDim.new(0, 20)
    UICorner_Toggle.Parent = ToggleButton

    UIAspectRatioConstraint_Toggle.Parent = ToggleButton
    UIAspectRatioConstraint_Toggle.AspectRatio = 4.1
